...
$emccArgs = "external/ayumi/ayumi.c", "-o", "public/ayumi.wasm", "-O3",
    "-s", "WASM=1",
    "-s", "EXPORTED_FUNCTIONS=`"[\`"_ayumi_configure\`", \`"_ayumi_set_pan\`", \`"_ayumi_set_tone\`", \`"_ayumi_set_noise\`", \`"_ayumi_set_mixer\`", \`"_ayumi_set_volume\`", \`"_ayumi_set_sid\`", \`"_ayumi_set_sid_waveform\`", \`"_ayumi_sid_reset\`", \`"_ayumi_set_syncbuzzer\`", \`"_ayumi_syncbuzzer_reset\`", \`"_ayumi_struct_size\`", \`"_ayumi_set_envelope\`", \`"_ayumi_set_envelope_shape\`", \`"_ayumi_process\`", \`"_ayumi_remove_dc\`", \`"_malloc\`", \`"_free\`"]`"",
